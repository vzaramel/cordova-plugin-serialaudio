...
public class AudioSerialOutMono {
	...
	private static byte logichigh = (byte) (-72);
	private static byte logiclow = (byte) (72);
	...
	public static byte[] SerialDAC(byte[] sendme)
	{
		if (levelflip)
		{
			logiclow = (byte) (-72);//(-128);
			logichigh = (byte) (72);//(16);
			jitter = (byte)(0);// (4);
		}
		else
		{
        ...
        //bits[bytesinframe-characterdelay-1] = false;
